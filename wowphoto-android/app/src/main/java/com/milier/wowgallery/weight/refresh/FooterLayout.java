...
class FooterLayout extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.footer_layout, this, false);
        addView(view);
    ...
    private void onBackNormalStatus() {
        ...
        mTitleTxt.setText(R.string.footer_hint_normal);
    ...
    private void onLoadStatusNoCallBack() {
        mTitleTxt.setText(R.string.footer_hint_loading);
    ...
    private void onCanReleaseStatus() {
        ...
        mTitleTxt.setText(R.string.footer_hint_ready);
        mProgressBar.setVisibility(View.GONE);
    }
    ...
    private boolean caseNoMoreData() {
        if (mNoMoreData) {
            mTitleTxt.setText(R.string.footer_no_more_data);
            mProgressBar.setVisibility(View.GONE);
        }
        return mNoMoreData;
    }
