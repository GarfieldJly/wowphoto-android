 ...
 */
public class HotestFragment extends Fragment implements RefreshLoadMoreLayout.CallBack, FragmentBaseView {
    View rootView;
    ...
    private ArrayList<WelfareBean.ResultsBean> mTempDatas = new ArrayList<>();
...
//        fragmentBasePresenter.loadDatas(ImageType.HOT, Constants.PAGE_SIZE, page);
    ...
    private void initEvent() {
        ...
        mRecelerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                int firstVisibleItem = ((LinearLayoutManager) mRecelerView.getLayoutManager()).findFirstVisibleItemPosition();
...
//                fragmentBasePresenter.loadDatas(ImageType.HOT, Constants.PAGE_SIZE, 1);
//            }
//        });
//
...
//    @Override
//    public void setData(List<AtlasBean> atlasBean) {
//
...
//                    mPictureAdapter.setLogin(false);
//                    mPictureAdapter.notifyDataSetChanged();
//                }
//
//            }
