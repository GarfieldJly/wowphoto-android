...
//    private ImageView mArrowImg;
    ...
    private void initView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.header_layout, this, false);
        addView(view);
...
//        mArrowImg.setVisibility(View.VISIBLE);
        ...
        mTitleTxt.setText(R.string.header_hint_normal);
...
//                mArrowImg.setRotation(0);
    ...
    private void onCanRefreshStatus() {
        mTitleTxt.setText(R.string.header_hint_ready);
        rotateArrow(0, -180);
    }
...
//                mArrowImg.setRotation(angel);
    ...
    private void onRefreshStatus() {
        mTitleTxt.setText(R.string.header_hint_loading);
    ...
    private String getLastUpdateTime() {
        ...
        if (TextUtils.isEmpty(getDateFormat())) {
            ...
            if (0 == days) {
                if (0 == hours) {
                    if (0 == minutes) {
                        return getContext().getString(R.string.header_time_justnow);
                    } else {
                        return minutes + getContext().getString(R.string.header_time_minutes);
                    }
                } else {
                    return hours + getContext().getString(R.string.header_time_hours);
                }
            } else {
                return days + getContext().getString(R.string.header_time_days);
            }
        } else {
