...
package com.milier.wowgallery.utils.googleplay;
...
public class IabHelper {
     ...
     * which will involve bringing up the Google Play screen. The calling activity_picturebrowse will be paused
     * while the user interacts with Google Play, and the result will be delivered via the
     * activity_picturebrowse's {@link Activity#onActivityResult} method, at which point you must call
     * this object's {@link #handleActivityResult} method to continue the purchase flow. This method
     * MUST be called from the UI thread of the Activity.
     *
     * @param act The calling activity_picturebrowse.
    ...
    /**
     * Handles an activity_picturebrowse result that's part of the purchase flow in in-app billing. If you
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data == null) {
            logError("Null data in IAB activity_picturebrowse result.");
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            logDebug("Successful resultcode from purchase activity_picturebrowse.");
